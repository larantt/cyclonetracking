...
vers = verd+vert
bbox = "BBox"+f'{argv[14]}' # Use BBox## for subsets
typ = f'{argv[15]}'
path = "/home/laratt/Documents/cycloneTracking/scriptTracking"+vers

# Time Variables
years = range(int(argv[3]),int(argv[4]))
mos = range(int(argv[5]),int(argv[6]))
dateref = [1900,1,1,0,0,0]

# Cyclone Parameters
# Aggregation Parameters
minls = int(argv[16]) # minimum lifespan (in days) for a track to be considered
mintl = int(argv[17]) # in km for version 11 and beyond
